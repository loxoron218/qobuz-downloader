...
**Primary Dependencies**: `gtk4`, `adw` (libadwaita), `qobuz-api-rust-refactor` (local path dep), `oo7` (keyring), `tokio`, `async-channel`, `parking_lot`, `serde` + `serde_json`, `tracing` + `tracing-subscriber`, `thiserror`, `anyhow`
